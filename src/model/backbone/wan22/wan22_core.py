...
class Wan22Core(torch.nn.Module):
    ...
    def __init__(
        ...
        self.train_scheduler = ContinuousFlowMatchScheduler(
            num_train_timesteps=num_train_timesteps,
            shift=train_shift,
        )
        self.infer_scheduler = ContinuousFlowMatchScheduler(
            num_train_timesteps=num_train_timesteps,
            shift=infer_shift,
        )
    ...
    def from_wan22_pretrained(
        ...
        model_id="./checkpoints/Wan2.2-TI2V-5B",
        tokenizer_model_id="./checkpoints/Wan2.2-TI2V-5B/google/umt5-xxl",
    ...
    def build_inputs(self, sample):
        ...
        input_latents = self._encode_video_latents(input_video) # [B, C, Latent_T, H', W']
    ...
    def infer(
        ...
        **kwargs
        ...
        z = self._encode_input_image_latents_tensor(input_image=input_image)
        latents[:, :, 0:1] = z
