...
from .io import LocalModelFile, hash_model_file, load_state_dict
...
from ..wan_video_vae import AttentionBlock, WanVideoVAE38
...
def load_wan22_ti2v_5b_components(
    ...
    tokenizer_model_id: str = "./checkpoints/umt5-xxl",
    ...
    for module in vae.modules():
        if isinstance(module, AttentionBlock):
            module.attention_backend = dit.attention_backend
