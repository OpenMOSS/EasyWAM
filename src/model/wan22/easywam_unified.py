...
from .action_dit import ActionDecoder, ActionEncoder, StateEncoder
from .attention import AttentionSegment, StructuredAttentionMask, build_structured_attention_mask
from .helpers.loader import load_wan22_ti2v_5b_components
from .schedulers.scheduler_continuous import WanContinuousFlowMatchScheduler
from .wan_video_dit import precompute_freqs_cis, sinusoidal_embedding_1d

logger = get_logger(__name__)


class EasyWAMUnified(nn.Module):
    """Wan2.2 EasyWAM-Unified model for single-chunk video/action prediction."""
    ...
    def _forward_dit(
        ...
        context_attn_mask = context_mask.unsqueeze(1).expand(-1, tokens.shape[1], -1).clone()
